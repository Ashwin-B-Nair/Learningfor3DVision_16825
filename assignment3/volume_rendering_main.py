...
def render_images(
    ...
    for cam_idx, camera in enumerate(cameras):
        ...
        if cam_idx == 0 and file_prefix == '':
            ...
            # img = img.clip(0, 1)
            plt.imsave('images/1.3_grid.png', img)
        ...
        if cam_idx == 0 and file_prefix == '':
            render_points('images/1.4_sample_pts.png', ray_bundle.sample_points.reshape(1, -1, 3))
    ...
    for epoch in range(start_epoch, cfg.training.num_epochs):
        ...
        if (
            ...
            with torch.no_grad():
                ...
                imageio.mimsave(f'images/part_4_materials_lowres_{epoch%cfg.training.render_interval}.gif', [np.uint8(im * 255) for im in test_images], loop=0)
