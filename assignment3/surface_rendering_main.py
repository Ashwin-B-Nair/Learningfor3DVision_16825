...
def train_images(
    ...
    for epoch in range(start_epoch, cfg.training.num_epochs):
        ...
        if (
            ...
            imageio.lmimsave(f'images/part_8_SDF_100view.gif', [np.uint8(im * 255) for im in test_images], loop=0)
            ...
            try:
                ...
                imageio.mimsave(f'images/part_8_geometry_100view.gif', [np.uint8(im * 255) for im in test_images], loop=0)
